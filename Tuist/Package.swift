...
let package = Package(
  ...
  dependencies: [
    ...
    .package(url: "https://github.com/FluidGroup/swiftui-gaussian-linear-gradient.git", from: "0.2.0"),
    ...
    .package(url: "https://github.com/FluidGroup/NextGrowingTextView.git", from: "3.0.0"),
