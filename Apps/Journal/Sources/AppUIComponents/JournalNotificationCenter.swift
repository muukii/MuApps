...
@MainActor
@Observable
public final class JournalNotificationCenter {

  /// The notification currently visible in the app overlay.
  public private(set) var current: JournalNotification?
  ...
  public func post(_ notification: JournalNotification) {
    dismissalTask?.cancel()
  ...
  public func dismiss(id: JournalNotification.ID) {
...
/// should be told.
public struct JournalNotification: Identifiable, Sendable {
...
public extension JournalNotification {
  ...
  static var mediaImportFailed: JournalNotification {
    JournalNotification(
      ...
      message: "Try choosing another item from Photos.",
